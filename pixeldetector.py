...
ap.add_argument("-d", "--downscale", required = False, type=int, default=0, help = "Downscale to new square width / height in pixels")
...
def pixel_detect(image: Image, downscale):
    ...
    if downscale == 0:
        ...
        return kCentroid(image, downscale, downscale, 2), image.width/downscale, image.height/downscale
...
if os.path.isfile(args["input"]):
    ...
    downscale, hf, vf = pixel_detect(image, args["downscale"])
